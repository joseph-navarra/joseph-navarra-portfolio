          ...
          <div class="space-y-6">
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <a :href="`mailto:${data.personal.email}`" class="text-white hover:text-cyan transition-colors">
                  {{ data.personal.email }}
                </a>
              </div>
            </div>
...
<script setup>
import { ref } from 'vue'
import { Mail, MapPin, Calendar, Github, Linkedin, Send } from 'lucide-vue-next'
