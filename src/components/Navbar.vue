<template>
  <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 pt-3">
    <div class="container mx-auto px-4 md:px-6">
      <div
        class="relative glass rounded-2xl px-6 h-14 md:h-16 flex items-center transition-all duration-300"
      ...
      >
        <div class="flex items-center justify-between w-full">
          ...
          >
            <span
              class="font-display text-2xl md:text-3xl font-bold tracking-tight"
            >
          ...
          <div class="hidden lg:flex items-center gap-1">
            ...
            >
              ...
              <div
                class="absolute inset-0 hover:bg-white/5 rounded-lg transition-colors"
              ></div>
            </a>
          </div>
